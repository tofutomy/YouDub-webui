...
const messages: Record<UiLanguage, Messages> = {
  en: {
    ...
    home: {
      ...
      localVideoLabel: "Upload video file",
      localDirLabel: "Local video path",
      localDirPlaceholder: "e.g. G:\\videos\\test.mp4",
      ...
      validateTranslation: "Validate translation (auto-correct issues)",
      stopAfterTranslate: "Stop after translation (subtitles only, no dubbing)",
      filterFillers: "Filter filler words & repeated short utterances (um, uh, 嗯, 啊…, short repeated chars are merged)",
      translateProviderLabel: "Translate provider",
      translateProviderDefault: "Default provider",
      ttsModeLabel: "TTS clone mode",
      ttsModeControllable: "Controllable clone (default)",
      ttsModeHifi: "Hi-Fi clone (highest fidelity)",
      ttsModeControllableDesc: "Clones timbre from reference audio. Supports style control instructions.",
      ttsModeHifiDesc: "Uses reference audio + transcript for maximum fidelity. Style control is ignored.",
      ...
      saveDefaultConfig: "Save as default config",
      defaultConfigSaved: "Default config saved.",
      defaultConfigSaveError: "Failed to save default config",
    ...
    settings: {
      ...
      unnamedProvider: "Untitled Provider",
      providerName: "Provider Name",
      providerNamePlaceholder: "e.g. OpenAI, DeepSeek",
      setDefaultProvider: "Set as default",
      deleteProvider: "Delete",
      saveProviderFirst: "Save the provider first to fetch models.",
    },
    status: {
      queued: "queued",
      running: "running",
  ...
  zh: {
    ...
    home: {
      ...
      localVideoLabel: "上传视频文件",
      localDirLabel: "本地视频路径",
      localDirPlaceholder: "例如 G:\\videos\\test.mp4",
      ...
      validateTranslation: "翻译校验（自动修正问题）",
      stopAfterTranslate: "翻译后中止（仅字幕，不配音）",
      filterFillers: "过滤语气词 & 重复短句（嗯、啊、um、uh…，重复的短字符也会合并）",
      translateProviderLabel: "翻译提供商",
      translateProviderDefault: "默认提供商",
      ttsModeLabel: "TTS 克隆模式",
      ttsModeControllable: "可控声音克隆（默认）",
      ttsModeHifi: "高保真克隆（最高保真度）",
      ttsModeControllableDesc: "从参考音频提取音色克隆，支持风格控制指令。",
      ttsModeHifiDesc: "使用参考音频+精确文本实现最高保真度克隆，控制指令会被忽略。",
      ...
      loadError: "加载任务失败",
      saveDefaultConfig: "保存为默认配置",
      defaultConfigSaved: "默认配置已保存。",
      defaultConfigSaveError: "保存默认配置失败",
      createError: "创建任务失败",
      paginationPrev: "上一页",
      paginationNext: "下一页",
