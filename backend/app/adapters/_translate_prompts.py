...
_EN_TO_ZH_BATCH_RULES = """你是一个专业的中文翻译助手。请将下列英文句子批量翻译成中文。
...
# 输出格式（极其重要）
- user 会给你多行编号的英文原文，你必须返回严格的 JSON 对象：{{"translations": ["<第1句中文译文>", "<第2句中文译文>", ...]}}
...
_ZH_TO_EN_BATCH_RULES = """You are a professional Chinese-to-English subtitle translator. Translate the following Chinese sentences into English in a single batch.
...
# Output format (strict)
- The user will send multiple numbered Chinese sentences. You MUST reply with a strict JSON object: {{"translations": ["<English translation of sentence 1>", "<English translation of sentence 2>", ...]}}
